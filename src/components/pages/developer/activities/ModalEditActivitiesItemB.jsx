...
const ModalEditActivitiesItemB = ({close}) => {
                ...
                <div>
                    <div className='mb-4'>
                        ...
                        <div className='relative group'>
                            <img src={`${devBaseImgUrl}/eventImageB.jpg`} className='h-[175px] w-full object-cover' alt="" />
...
export default ModalEditActivitiesItemB