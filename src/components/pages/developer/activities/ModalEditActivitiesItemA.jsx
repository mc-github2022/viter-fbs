...
const ModalEditActivitiesItemA = ({close}) => {
                ...
                <div>
                    <div className='mb-4'>
                        ...
                        <div className='relative group'>
                            <img src={`${devBaseImgUrl}/eventImageA.jpg`} className='h-[175px] w-full object-cover' alt="" />
                    ...
                    <div className="inputGroup mb-4">
                        <label htmlFor="" className=''>Activity Title</label> <br />
                    ...
                    <div className="inputGroup mb-4">
                        <label htmlFor="" className=''>Button Text</label> <br />
                        <input type="text" className='border-customGray border w-full h-[36px] mb-1' /> <br />
                    </div>
                    <div className="inputGroup mb-4">
                        <label htmlFor="" className=''>Button Link</label> <br />
                        <input type="text" className='border-customGray border w-full h-[36px] mb-1' /> <br />
                    </div>
                </div>
