...
const ModalEditServicesItemD = ({close}) => {
  ...
  return (
    ...
    <div className='bg-dark bg-opacity-30 fixed z-10 left-0 top-0 w-full h-[100dvh]'>
        <div className="modal scroll-m-0 absolute top-0 bg-light px-4 w-[350px] right-0 h-full">
            <h2 className='font-semibold py-4'>Update Services Item D</h2>
                    ...
                    <div>
                        <div className='mb-4'>
                            ...
                            <div className='relative group'>
                                <img src={`${devBaseImgUrl}/lcssIcon.png`} className='h-[175px] w-full object-cover' alt="" />
...
export default ModalEditServicesItemD