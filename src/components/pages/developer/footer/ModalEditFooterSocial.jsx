...
const ModalEditFooterSocial = ({close}) => {
                ...
                <div className=''>
                    <div>
                        <div className="inputGroup mb-4">
                            <label htmlFor="" className=''>Facebook Link</label> <br />
                        ...
                        <div className="inputGroup mb-4">
                            <label htmlFor="">Tiktok Link</label> <br />
                            <input type="text"  className='border-customGray border w-full h-[36px] mb-1' /> <br />
                        </div>
                        <div className="inputGroup mb-4">
                            <label htmlFor="">Linked In Link</label> <br />
                            <input type="text"  className='border-customGray border w-full h-[36px] mb-1' /> <br /> 
                        </div>
                    </div>
