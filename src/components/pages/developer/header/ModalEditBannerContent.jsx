...
const ModalEditBannerContent = ({close}) => {
  ...
  return (
    ...
    <div className='bg-dark bg-opacity-30 fixed z-10 left-0 top-0 w-full h-[100dvh]'>
        <div className="modal scroll-m-0 absolute top-0 bg-light px-4 w-[350px] right-0 h-full">
            ...
            <button className="btnClose absolute right-8 top-5" onClick={handleClose}><IoMdClose /></button>
                <div className=''>
                    <div>
                    ...
                    <div className='btnUpdate absolute bottom-0 py-4 flex gap-2'>
                        ...
                        <button type="reset" value="" className='btn' onClick={handleClose}>Cancel</button>
                    </div>
                </div>
        </div>
    </div>
