...
const ModalEditHeaderContent = ({close}) => {
                ...
                <div className=''>
                    <div>
                        <div className="inputGroup mb-4">
                            <label htmlFor="" className=''>Menu Item 1</label> <br />
                            <input type="text" className='border-customGray border w-full h-[36px] mb-1' /> <br />
                        </div>
                        <div className="inputGroup mb-4">
                            <label htmlFor="">Menu Item 2</label> <br />
                            <input type="text"  className='border-customGray border w-full h-[36px] mb-1' /> <br />
                        </div>
                        <div className="inputGroup mb-4">
                            <label htmlFor="">Menu Item 3</label> <br />
                            <input type="text"  className='border-customGray border w-full h-[36px] mb-1' /> <br />
                        </div>
                        <div className="inputGroup mb-4">
                            <label htmlFor="">Menu Item 4</label> <br />
                            <input type="text"  className='border-customGray border w-full h-[36px] mb-1' /> <br />
                        </div>
                        <div className="inputGroup mb-4">
                            <label htmlFor="">Menu Item 5</label> <br />
                            <input type="text"  className='border-customGray border w-full h-[36px] mb-1' /> <br /> 
                        </div>
                    </div>
...
export default ModalEditHeaderContent